...
const Contact = () => {
    return (
        <>
            ...
            <p className="text-center text-[1.4rem] md:w-[60%] md:mx-auto font-bold cursor-pointer hover:text-secondary-400 flex items-center justify-center mt-4 gap-2"><IoMdMail className="mt-[.3rem] text-[1.6rem]" />luwaservices@gmail.com</p>
            <h4></h4>
        </>
    )
}
